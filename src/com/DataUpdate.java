...
public class DataUpdate implements com.wabacus.system.serveraction.IServerAction{
	
	public static String  Copy(String suoshu,String table,String yuanjieduan,String xianjieduan)
	{
			...
			if(dao.update(table,newcols,newvalues,updateCol,updateValue).contains("SUCCESS"))
			{
				String zzNengLiTable[] = new String[] {  
					...
					for(int i=0;i<zzNengLiTable.length;i++)
					{
					    ...
					    if(!DataCopy.CopyData(suoshu, temp, yuanjieduan, xianjieduan))
					    {
	...
	public String executeServerAction(HttpServletRequest arg0,
		...
		return Copy(arg2.get(0).get("suoshu"),arg2.get(0).get("table"),arg2.get(0).get("yuanjieduan"),arg2.get(0).get("xianjieduan"));
	}
